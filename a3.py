...
def title_by_year(matches: List[str]) -> List[str]:
    ...
    for year in matches:
        for movie in movie_db:
            if (get_year(movie) == int(year)):
                to_return.append(get_title(movie))
    return to_return
...
def title_by_year_range(matches: List[str]) -> List[str]:
    ...
    """
    to_return = []
    for iteration in range(int(matches[0]),int(matches[1]) +1):
        for movie in movie_db:
            if (get_year(movie) == iteration):
                to_return.append(get_title(movie))
            # print(to_return)
    return to_return
    ...
    for title in matches:
        for movie in movie_db:
            if (get_title(movie) == title):
                to_return.append(get_director(movie))
            # print(to_return)
    return to_return
...
def year_by_title(matches: List[str]) -> List[int]:
    ...
    for title in matches:
        for movie in movie_db:
            if (get_title(movie) == title):
                to_return.append(get_year(movie))
            # print(to_return)
    return to_return
